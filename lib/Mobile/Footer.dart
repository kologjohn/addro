    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text('Copyright © 2023 Addro.  Powered by', style:TextStyle(fontStyle: FontStyle.italic),),
                  TextButton(
                      onPressed: ()async {
                        String url = "https://www.kologsoft.com/";
          ...
          InkWell(
            onTap: (){
              Navigator.push(BuildContext as BuildContext , MaterialPageRoute(builder: (context)=>  ResponsiveLayout(mobilescaffold: MobileScaffold(),tabletscaffold: TabletScaffold(),desktopscaffold: DesktopScaffold(),)),
              );
            },
