...
class Content {
  ...
  static String partners ='ADDRO’s long term partners in the recent past include Episcopal Relief and Development (USA)\n'
      'Comic Relief (UK), Health Partners International of Canada (HPIC) and SNV (Netherlands).';
}

class Programs{
  static String a ='Integrated Community Case Management (ICCM) for Malaria, diarrhea and pneumonia: This is part of ADDRO’s Community-Based health program implemented in 6 regions and has directly impacted the lives of 3533 Mothers/Care givers and 9780 Children under 5 years and 5887 other Community Members as indirect beneficiaries.';
